    ...
    <div class="bg-light" dir="rtl">
        <div class="container mt-4">
            ...
            <div class="card shadow-lg p-4 mt-3 narrow-form"> <!-- Add narrow-form class here -->
                ...
                <form action="{{ route('admin.tenders.store_tender') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3 d-flex align-items-center gap-5">
                        <div class="flex-grow-1 w-50">
                            ...
                            <input type="text" class="form-control" id="tenderNumber" name="tenderNumber" required>
                        </div>
                        <div class="w-50">
                            <label class="form-label"> {{ 'نوع الاعلان' }} </label>
                            <div class="radio-group">
                                <label class="radio-label">
                                    <input type="radio" id="tenderTypeInternal" name="tenderType" value="internal" class="radio-input">
                                    <span class="radio-custom"></span>
                                    <span class="radio-text"> {{ 'داخلي' }} </span>
                                </label>
                                <label class="radio-label">
                                    <input type="radio" id="tenderTypeExternal" name="tenderType" value="external" class="radio-input">
                                    <span class="radio-custom"></span>
